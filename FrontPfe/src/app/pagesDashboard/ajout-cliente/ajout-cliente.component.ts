...
@Component({
  selector: 'app-ajout-cliente',
  templateUrl: './ajout-cliente.component.html',
  styleUrls: ['./ajout-cliente.component.css'],
})
export class AjoutClienteComponent implements OnInit {
